...
% Exercise 19
\begin{defn}
	A vector space $\mathrm{V}$ is called direct sum of $W_1$ and $W_2$ if $W_1$ and $W_2$ are subspace of $\mathrm{V}$ such thay $W_1\,\cap \,W_2 = \{0\}$ and $W_1 + W_2 = \mathrm{V}$. We denote that $\mathrm{V}$ is the direct sum of $W_1$ and $W_2$ by  Writting $\mathrm{V} = W_1\oplus W_2$.
\end{defn}
% Exercise 23
